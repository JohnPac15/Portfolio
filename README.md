 ...
 * [Screenshots](#Screenshots)
 ## Installation
run "npm install" after you have cloned or forked the repo. Then run "npm start" it will automatically open and start the app
 ## Usage 
 This is a classic professional portfolio you could use for any type of business profession
 ## Credits 
 John Pacini
 ## License 
 No License 
 ...
 undefined
 ## Features 
 React, Github Pages, SPA, Bootstrap
 ## Contributing 
